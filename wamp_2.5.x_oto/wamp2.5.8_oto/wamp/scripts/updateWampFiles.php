...
$wamp_oto_version = "2.5.8";

require ('wampserver.lib.php');
require 'config.inc.php';

$always_verify = false;
if(!empty($_SERVER['argv'][1]) && $_SERVER['argv'][1] =='always')
	$always_verify = true;
	
//Check if some parameters exists in wampmanager.conf

if(version_compare($wampConf['wampserverVersion'], $wamp_oto_version) < 0 || $always_verify) {
	...
	if($wampConf['wampserverVersion'] != $wamp_oto_version ) {
