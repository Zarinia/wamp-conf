...
';
  elseif ($params_for_wampini[$paramname] == -2) //[modif oto] - || blue to indicate different from 0 or 1 or On or Off
     $phpConfText .= 'Type: item; Caption: "'.$paramname.'"; Action: multi; Actions: '.$phpParams[$paramname].' ; Glyph: 22;
';
}
...
";
			...
			$nb_Virtual = preg_match_all("/^(?![ \t]*#).*<VirtualHost \*:(.*)>$/m", $myVhostsContents, $Virtual_matches);
