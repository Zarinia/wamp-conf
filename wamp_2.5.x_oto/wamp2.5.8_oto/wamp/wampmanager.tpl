...
Modified (2.5 to 2.5.8) by Otomatic (otomatic@otomatic.net)
...
Action: run; FileName: "${c_phpCli}";Parameters: "updateWampFiles.php always";WorkingDir: "${c_installDir}/scripts"; Flags: waituntilterminated
...
[wampreload]
;WAMPRELOADSTART
Action: run; FileName: "${c_phpCli}";Parameters: "updateWampFiles.php";WorkingDir: "${c_installDir}/scripts"; Flags: waituntilterminated
Action: run; FileName: "${c_phpCli}";Parameters: "refresh.php";WorkingDir: "${c_installDir}/scripts"; Flags: waituntilterminated
Action: resetservices
Action: readconfig;
;WAMPRELOADEND
