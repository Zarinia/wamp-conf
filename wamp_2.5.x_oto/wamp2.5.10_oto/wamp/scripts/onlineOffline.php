...
$httpConfFileContents = preg_replace("/\r\n?/", "\n", $httpConfFileContents);
...
$nb = 0;
$httpConfFileContents = preg_replace("~(^[ \t]*#[ \t]*onlineoffline tag.*$)((?:.|\n)+?)(^[ \t]*</Directory>$)~m", "$1".$replacement."$3", $httpConfFileContents, -1, $nb);
