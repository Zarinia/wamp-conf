...
$langues = array(
	'en' => array(
		...
		'VirtualSubMenuOn' => 'The <code>VirtualHost sub-menu</code> item must be validated (On) in the <code>Wamp Settings</code> Right-Click menu',
		'UncommentInclude' => 'Uncomment <small>(Suppress #)</small> the lien <code>#Include conf/extra/httpd-vhosts.conf</code><br>in file %s',
		...
		'Correct' => 'Start the automatic correction of green errors',
		...
		'However' => 'You may add another VirtualHost by validate "Add a VirtualHost".<br>However, for these new VirtualHost are taken into account by Apache, you must run item<br><code>Restart All Services</code><br>from menu of Wampmanager icon. <i>(This can unfortunately not be done automatically)</i>',
	),
	'fr' => array(
		'langue' => 'Français',
		'locale' => 'french',
		...
		'VirtualSubMenuOn' => 'L\'item <code>Sous-menu VirtualHost</code> doit être validé dans le menu Clic-Droit <code>Paramètres Wamp</code>',
		...
		'Correct' => 'Démarrer la correction automatique des erreurs vertes',
		...
		'However' => 'Vous pouvez ajouter un autre VirtualHost en validant "Ajouter un VirtualHost"<br>Cependant, pour que ces nouveaux VirtualHost soient pris en compte par Apache, vous devez lancer l\'item<br><code>Redémarrer les services</code><br>du menu de l\'icône Wampmanager. <i>(Ceci ne peut, hélas, pas être fait automatiquement)</i>',
	)
);
