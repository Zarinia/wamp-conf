...
function linkPhpDllToApacheBin($php_version)
{
	...
	//Create symbolic link instead of copy files
...
function switchPhpVersion($newPhpVersion)
{
	...
	// Create symbolic link to phpForApache.ini file of active PHP version
	...
	//Create symbolic link to php dll's instead of copy files
