<?php
//[modif oto] - Wampserver 2.5.4
$wampserverVersionOto = "2.5.4";
// variable $c_suppressLocalhost globale par wampmanager.conf
// Quatre possibilités de configuration ajoutées dans wampmananer.conf à la fin de la section [main]
// urlAddLocalhost = "off"
...
//[modif oto] Ajout variable suppressLocalhost based on urlAddLocalhost
...
//[modif oto] - dll to create symbolic links from php to apache/bin
$icu = array(
