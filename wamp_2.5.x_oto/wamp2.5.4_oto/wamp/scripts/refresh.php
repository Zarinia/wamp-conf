<?php
//[modif oto] - After Wampserver 2.5
// Three configuration options added in wampmanager.conf at the end of the [main] section
// urlAddLocalhost = "off"
// VirtualHostSubMenu = "off"
// ProjectSubMenu = "off"
// Adding a Settings sub-menu right-click to manage the configuration options above
// In wampmanager.tpl after ;WAMPLANGUAGEEND add
//
// [settings]
// ;WAMPSETTINGSSTART
// ;WAMPSETTINGSEND
// Plus new script wamp/scripts/switchWampParam.php
...
//   on the dll files in the active version of php
