...
Modified (2.5 to 2.5.9) by Otomatic (otomatic@otomatic.net)
...
Action: run; FileName: "${c_phpCli}";Parameters: "checkWampFiles.php always";WorkingDir: "${c_installDir}/scripts"; Flags: waituntilterminated
