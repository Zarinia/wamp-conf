...
Wampserver 2.2e 32bits - Apache `2.4.12`/2.2.29 - Nginx 1.9.2 - PHP 5.5.10/5.5.26/`5.4.42`/5.3.29 - MySQL 5.6.24/`5.5.40` - MariaDB 10.0.20/`5.5.40` - PhpMyAdmin 4.4.10 - Xdebug 2.3.3 - MysqlDumper 1.24.4 - Adminer 4.2.1 - PhpSysInfo 3.2.2 - (Windows 7 Ultimate SP1 32bits) --- _Si debugger, c'est supprimer des bugs, alors programmer ne peut être que les ajouter._
